...
import categories.categories2018.bots.ExecuteNNBot2018;
...
public class LoaderExecuteBot2018 implements MarketChangeListener,MarketProviderListerner{
	...
	public LoaderExecuteBot2018() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
		...
		ExecuteNNBot2018 eNNBot = new ExecuteNNBot2018(md);

		md.runFile();

		System.out.println("ExecuteNNBot2018 Runned");
			 ...
			 if(close==null)
			 {
				 ...
				 close.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						if(!Parameters.replay)
						{
							LoaderExecuteBot2018.this.md.stopPolling();
							LoaderExecuteBot2018.this.logout();
	...
	public static void main(String[] args)  throws Exception {
		...
		Parameters.graphicalInterface=false; // see markets windows
