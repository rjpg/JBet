...
public class ProcessOutoutRawData {
	...
	{
		double minmax[][]=new double[OUTPUTS_ROWS][2];
...
//			}
	...
	{
		String fileName=CategoryNode.getAncestorsStringPath(cat)+"NNMinMaxOut.csv";
	...
	public static Vector<double[]> normalize(Vector<double[]> examples,double[][] minmax)
	{
		...
		{
			double normalExample[]=new double[OUTPUTS_ROWS];
	...
	public static void main(String[] args) {
			...
			double filters[] =new double[OUTPUTS_ROWS];
			...
			//for(int i=0;i<648;i++)
			{
				...
				if(file.exists()) { 
					...
					// para deixar no original
					writeTalbleFile(normalizeExamples,cat,"NNNormalizeDataOut.csv");
