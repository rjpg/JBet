...
import categories.categories2018.LoaderCollectRaw2018;
...
public class LoaderStatsPaper implements MarketChangeListener,MarketProviderListerner{
	...
	public LoaderStatsPaper() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
			 ...
			 if(close==null)
			 {
				 ...
				 close.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						if(!Parameters.replay)
						{
							LoaderStatsPaper.this.md.stopPolling();
							LoaderStatsPaper.this.logout();
